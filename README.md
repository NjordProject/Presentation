...
###Contacts extérieurs
L'une des caracteristique de notre PFE est la prise de contact avec de nombreuses entités　exterieures. Que ce soit pour les porte- moteurs, la creation de la pcb ou la découpe. Le temps de recherche de ces contacts, ainsi que le temps de créations/modifications des pièces constituaient une durée d'attente non reductible. Ainsi, du fait de cette attente, (associé a la perte de temps de recherche de ces contacts), les premiers vrais essais arrivèrent trop en aval du processus de création (février), ne nous laissant pas le temps de créer une seconde version utilisant l'expérience acquise précédement. Dans l'ideal, les premiers essais auraient dû se dérouler fin 2014.
...
###Montage
En l'absence de logistique adaptée et peu coûteuse, il a été décidé de faire de notre circuit imprimé notre châssis. Outre le coté très artisanal de ce choix, il présente 2 inconvénients majeurs:
...
Même si nous pouvions faire un drone qui vole et qui récupère bien les données relative à la zone étudiée. Il nous resterait encore la problématique de la détermination de la position du drone dans l'espace à régler. Bien que localiser un drone sur une grande étendue en extérieur soit faisable à l'aide d'un GPS. Le faire dans une pièce, est beaucoup plus compliqué. C'est une problématique encore au stade de la recherche.
